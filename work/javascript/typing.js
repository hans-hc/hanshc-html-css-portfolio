...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function startGame() {
        selectedText = generateRandomText();
        textToTypeElement.textContent = selectedText;
        userInput.value = "";
        timeElement.textContent = "0";
        wpmElement.textContent = "0";
        resultMessage.textContent = ""; // Clear the result message on restart
        startTime = null;
    ...
    userInput.addEventListener("input", () => {
        ...
        if (typedText.trim() === selectedText) {
            clearInterval(interval);
            resultMessage.textContent = `You finished with a speed of ${wpmElement.textContent} WPM!`;
        }
    });
    ...
    helpButton.addEventListener("click", () => {
        helpText.classList.remove("hidden"); // Show the help text
    });
});
